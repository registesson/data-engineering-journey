# Learning Log — Data Engineering Transition

> Régis · Démarré le 18 mars 2026  
> Roadmap : 6–9 mois · Phase 1 → Fondations Python & SQL

---

## Format d'entrée

Chaque session = un bloc daté avec 4 champs fixes.

```
### YYYY-MM-DD · Sujet · Durée
**Ce que j'ai fait** : ...
**Ce que j'ai appris** : ...
...
- [ ] SQL : Optimisation et indexation
- [ ] Python : scripting, fonctions, modules
- [ ] dbt : modèles, tests, documentation
- [ ] Airflow : DAGs, opérateurs, scheduling
- [ ] Docker : images, containers, compose
- [ ] Spark : RDDs, DataFrames, transformations
